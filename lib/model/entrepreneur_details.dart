import 'entrepreneur_business_related_problem.dart';
import 'entrepreneur_collected_officer.dart';
import 'entrepreneur_expected_support.dart';
import 'entrepreneur_qualification.dart';
import 'entrepreneur_training_program.dart';

final String tableRegistration = 'Entrepreneurs';
...
class EntrepreneurDetails {
  ...
  List<EntrepreneurCollectedOfficer> CollectedOfficerDetails;
  ...
  EntrepreneurDetails({
      this.id,
      this.nic,
      this.experienceFieldId,
      this.entrepreneurshipLevelId,
      this.professionalQualificationLevelId,
      this.entrepreneurshipId,
      this.professionalQualificationId,
      this.dsDivisionDivisionId,
      this.districtId,
      this.educationQualificationQualificationId,
      this.name,
      this.initials,
      this.address,
      this.contactNo,
      ...
      this.expectedSupportId,
      this.businessRelatedProblemId,
      this.officerNic,
      this.bType,
      this.educationLevelText,
      this.contactNo2,
      this.fullname,
      this.gnGnDivisionId,
      this.enteredOfficer,
      ...
      this.title,
      this.activeStatus,
      this.collectedOfficerName,
      this.collectedOfficerNic,
      this.collectedOfficerDesignation,
      this.trainingProgram,
      this.expectedSupport,
      this.BusinessRelatedProblem,
      this.Qualifications,
      this.CollectedOfficerDetails,
      this.isSync});

  EntrepreneurDetails copy({
    int id,
    String nic,
    String experienceFieldId,
    String entrepreneurshipLevelId,
    ...
    int isSync,
        ...
        BusinessRelatedProblem:BusinessRelatedProblem ?? this.BusinessRelatedProblem,
        Qualifications:Qualifications ?? this.Qualifications,
        CollectedOfficerDetails:CollectedOfficerDetails ?? this.CollectedOfficerDetails,
        isSync:isSync ?? this.isSync,
      );

  EntrepreneurDetails.fromJson(Map<String, dynamic> json) {
    nic = json['NIC'];
    experienceFieldId = json['EXPERIANCE_FIELD_ID'];
    entrepreneurshipLevelId=json['ENTREPRENEURSHIP_LEVEL_ID'];
    professionalQualificationLevelId=json['PROFESSIONAL_QUALIFICATION_LEVEL_ID'];
    entrepreneurshipId=json['ENTREPRENEURSHIP_ID'];
    professionalQualificationId=json['PROFESSIONAL_QUALIFICATION_ID'];
    dsDivisionDivisionId=json['DS_DIVISION_DIVISION_ID'];
    districtId=json['DISTRICT_ID'];
    educationQualificationQualificationId=json['EDUCATION_QUALIFICATION_QUALIFICATION_ID'];
    name=json['NAME'];
    ...
    expectedSupportDescribe=json['EXPECTED_SUPPORT_DESCRIBE'];
    expectedSupportId=json['EXPECTED_SUPPORT_ID'];
    businessRelatedProblemId=json['BUSINESS_RELATED_PROBLEM_ID'];
    officerNic=json['OFFICER_NIC'];
    bType=json['B_TYPE'];
    educationLevelText=json['education_level_text'];
    contactNo2=json['CONTACT_NO2'];
    fullname=json['FULLNAME'];
    gnGnDivisionId=json['GN_GN_DIVISION_ID'];
    enteredOfficer=json['ENTERED_OFFICER'];
    updatedOfficer=json['UPDATED_OFFICER'];
    enteredTime=json['ENTERED_TIME'];
    updatedTime=json['UPDATED_TIME'];
    wayOfAwareId=json['WAY_OF_AWARE_ID'];
    wayOfAwareText=json['way_of_aware_text'];
    isSameOfficer=json['issameofficer'];
    ...
    if (json['TrainingProgram'] != null) {
      ...
      json['TrainingProgram'].forEach((v) {
        trainingProgram.add(EntrepreneurTrainingPrograms.fromJson(v));
      });
    }
    ...
    if (json['ExpectedSupport'] != null) {
      ...
      json['ExpectedSupport'].forEach((v) {
        expectedSupport.add(EntrepreneurExpectedSupport.fromJson(v));
      });
    }

    // BusinessRelatedProblem=json['BusinessRelatedProblem'];

    if (json['BusinessRelatedProblem'] != null) {
      BusinessRelatedProblem = [];
      json['BusinessRelatedProblem'].forEach((v) {
        BusinessRelatedProblem.add(EntrepreneurBusinessRelatedProblem.fromJson(v));
      });
    }
    ...
    if (json['Qualifications'] != null) {
      ...
      json['Qualifications'].forEach((v) {
        Qualifications.add(EntrepreneurQualification.fromJson(v));
      });
    }
    // CollectedOfficerDetails=json['CollectedOfficerDetails'];
    if (json['CollectedOfficerDetails'] != null) {
      CollectedOfficerDetails = [];
      json['CollectedOfficerDetails'].forEach((v) {
       CollectedOfficerDetails.add(EntrepreneurCollectedOfficer.fromJson(v));
       CollectedOfficerDetails.forEach((element) {
         collectedOfficerName=element.officerName;
         collectedOfficerNic=element.officerNic;
         collectedOfficerDesignation=element.officerDesignation;
       });
      });
    }
  }
  ...
  static EntrepreneurDetails fromJsonDb(Map<String,Object>json) => EntrepreneurDetails(
     ...
     isSync:json!=null?int.tryParse(json[EntrepreneurDataFields.COL_ENTREPRENEUR_IS_SYNC]??"")??0:0,
  );
