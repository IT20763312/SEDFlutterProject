...
class PageCover extends StatefulWidget {
  ...
  PageCover({@required this.title, @required this.needBack, @required this.needBottom, @required this.body,Key key,this.needTop,this.needBackground,this.isHome}): super(key: key);

  // PageCover({Key key}) : super(key: key);
      ...
      body: SafeArea(
          child: Container(
            decoration: widget.needBackground==null || widget.needBackground? const BoxDecoration(
                image: DecorationImage(image: AssetImage("assets/image/back.jpg"),fit: BoxFit.cover)
            ):null,
            child: Column(
              children: [
